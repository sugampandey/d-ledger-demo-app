...
// // Add this new code for sidebar navigation
...
// try {
//     const response = await fetch(`/api/accounts/${accountId}?company_id=${companyId}`);
...
// document.getElementById('listAccountsForm').addEventListener('submit', async (e) => {
// e.preventDefault();
...
// } catch (error) {
//     document.getElementById('listResult').textContent = 'Error: ' + error.message;
// }
// });
...
document.addEventListener('DOMContentLoaded', function() {
    const accountsForms = document.querySelectorAll('#getAccountForm, #listAccountsForm, #createAccountForm');
    
    accountsForms.forEach(form => {
      if (form) {
        form.addEventListener('submit', async (e) => {
          ...
          try {
            ...
            switch(formId) {
              case 'getAccountForm':
                console.log('Processing get account form submission...');
                const accountId = document.getElementById('accountId').value;
                const companyId = document.getElementById('getCompanyId').value;
                response = await fetch(`/api/accounts/${accountId}?company_id=${companyId}`);
                resultElement = document.getElementById('getResult');
                break;
                
              case 'getAccountForm':
                console.log('Processing list accounts form submission...');
                const params = new URLSearchParams({
                    company_id: document.getElementById('listCompanyId').value,
                    maxresults: document.getElementById('maxResults').value,
                    startposition: document.getElementById('startPosition').value
                ...
                const response = await fetch(`/api/accounts?${params.toString()}`);
                resultElement = document.getElementById('listResult');
                break;
